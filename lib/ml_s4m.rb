      ...
      unless partNumber.nil?
        ...
        begin
          ...
          unless page.nil?
            ...
            list_price = []
            list.each do |item|
              unless item.children[1].nil? || tem.children[1].children[1].children[1].children[2].children[1].nil? || tem.children[1].children[1].children[1].children[2].children[1].children[3].nil? 
